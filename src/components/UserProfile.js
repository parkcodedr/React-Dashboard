  ...
  return (
    <div className="nav-item absolute right-1 top-16 bg-white dark:bg-[#42464D] p-4 rounded-lg w-46">
      ...
      <div className="flex gap-2 items-center mt-6 border-color border-b-1 pb-6">
        ...
        />
        <div>
          <p className="font-semibold text-sm dark:text-gray-200"> Michael Roberts </p>
      ...
      <div>
        {userProfileData.map((item, index) => (
          <div key={index} className="flex gap-2 border-b-1 border-color p-2 hover:bg-light-gray cursor-pointer  dark:hover:bg-[#42464D]">
            <button
              type="button"
